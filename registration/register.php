...
function handleChange(input) {
    ...
    if (input.value > 45) input.value = 45;
  }
...
<br /><br /><br /><br />
<form name="n" method="post" action="register.php" >
<center> <strong><font  face="Century Gothic" color="#00CCFF" size="+1">USN should be unique, if duplicate entry is there then your data will not be inserted into the database </font></strong></center><br>
<center> <strong><font size="+1" color="#FF0000"><font face="Century Gothic" color="#00CCFF"> Enter the number of participants (including Accompanist, Coordinator and Participants) &nbsp;&nbsp;&nbsp;&nbsp; 
</font><input type="text" name="number" size="3" onkeypress="return numbersonly(event)" onchange="handleChange(this);" maxlength="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="submit" name="submit" value="SUBMIT" onClick="return confirmSubmit();is_loaded()"/></strong></center> 
</form>
...
<form name="final" action="register_final.php" method="post" onsubmit="return validation();">
 <?php    $i=1;
	  while($i<=$_POST['number'])
	  {
	  
	   echo "<tr> <th><font color='#FFFFFF' face='Century Gothic'>".$i++."</font></th>";?>	   
